...
class GlobalEnviromentSettings:
    ...
    def __init__(self) -> None:
        self.file_name:              str = ".com.intsant.oclp-r.plist"
    ...
    def _generate_settings_file(self) -> None:
        if Path(self.global_settings_plist).exists():
            return
        try:
            plistlib.dump({"Developed by Intsant and Intsant": True,}, Path(self.global_settings_plist).open("wb"))
        except PermissionError:
    ...
    def _convert_defaults_to_global_settings(self) -> None:
        ...
        defaults_path = "~/Library/Preferences/com.intsant.oclp-r.plist"
