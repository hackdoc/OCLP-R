...
If you plan to create the USB for another machine, please select the "Change Model" option in the menu.""",
                ...
                "MetallibSupportPkg missing, generating MetallibSupportPkg Download frame":"MetallibSupportPkg missing, generating MetallibSupportPkg Download frame",
                "MetallibSupportPkg Download complete, installing Metallib PKG":"MetallibSupportPkg Download complete, installing Metallib PKG",
...
如果您计划为另一台机器创建 USB，请在菜单中选择"更改型号"选项。""",
                ...
                "MetallibSupportPkg missing, generating MetallibSupportPkg Download frame":"缺少MetallibSupportPkg, 正在生成MetallibSupportPkg下载框架",
                "MetallibSupportPkg Download complete, installing Metallib PKG":"MetallibSupportPkg下载完成, 正在安装Metallib PKG",
    ...
    def gui_KDK_download(self):
        if self.language_point=="English":
            trans={
                ...
                "Initializing KDK Download Frame":"Initializing KDK Download Frame",
                "Finding Available Kernal Debug Kit":"Finding Available Kernal Debug Kit",
                "Choose KDK Version":"Choose KDK Version",
                "Select KDK":"Select KDK",
            ...
            trans={
                ...
                "Finding Available Kernal Debug Kit":"正在获取 KDK",
    ...
    def gui_macos_installer_flash(self):
        if self.language_point=="English":
            trans={
                ...
                "Initiating MetallibSupportPkg Download":"Initiating MetallibSupportPkg Download",
            ...
            trans={
                ...
                "Initiating MetallibSupportPkg Download":"正在初始化 MetallibSupportPkg 下载",
                "Failed to retrieve Metallib":"无法检索 Metallib",
                "Failed to mount KDK":"无法挂载 KDK",
                "Failed to download Metallib":"无法下载 MetallibSupportPkg",
    ...
    def gui_main_menu(self):
        if self.language_point=="English":
            trans={
                ...
                "MetallibSupportPkg Download":"MetallibSupportPkg Download",
...
""",
                ...
                "MetallibSupportPkg Download":"下载 MetallibSupportPkg",
    ...
    def gui_metallib_download(self):
        if self.language_point=="English":
            trans={
                ...
                "Finding Available Metallibs":"Finding Available Metallibs",
                "Select MetallibSupportPkg Version":"Select MetallibSupportPkg Version",
                "Select MetallibSupportPkg":"Select MetallibSupportPkg",
                ...
                "Copy MetallibSupportPkg Download Link":"Copy MetallibSupportPkg Download Link",
                "Return to Main Menu":"Return to Main Menu",
            ...
            trans={
                ...
                "Initializing NewMetallibDownloadFrame":"初始化新的 MetallibSupportPkg 下载框架",
                "Finding Available Metallibs":"正在获取 Metallib",
                "Select MetallibSupportPkg Version":"选择 MetallibSupportPkg 版本",
                "Select MetallibSupportPkg":"选择 MetallibSupportPkg",
                "Failed to download Metallib message from Github":"无法从 Github 下载 MetallibSupportPkg 消息",
                "Download":"下载",
                "Copy Link":"复制链接",
                "Download Selected Metallib":"下载选定的 Metallib",
                "Copy MetallibSupportPkg Download Link":"复制 MetallibSupportPkg 下载链接",
                "Return to Main Menu":"返回主菜单",
    ...
    def gui_sys_patch_start(self):
        if self.language_point=="English":
            trans={
                ...
                "Finding Available MetallibsupportPkg database...":"Finding Available MetallibsupportPkg database...",
                "MetallibSupportPkg Download failed: ":"MetallibSupportPkg Download failed: ",
            ...
            trans={
                ...
                "MetallibSupportPkg Download complete, installing Metallib PKG":"MetallibSupportPkg 下载完成，正在安装 Metallib PKG",
                "Metallib Build ":"Metallib 构建 ",
                "MetallibSupportPkg missing, generating MetallibSupportPkg Download frame":"MetallibSupportPkg 缺失，正在生成 MetallibSupportPkg 下载框架",
                ...
                "Finding Available MetallibsupportPkg database...":"正在获取 MetallibSupportPkg 数据库...",
                "MetallibSupportPkg Download failed: ":"MetallibSupportPkg 下载失败：",
    ...
    def sys_patch(self):
        if self.language_point=="English":
            ...
            trans={
                ...
                "Could not download MetalLibSupportPkg: {error_msg}":"无法下载 MetallibSupportPkgSupportPkg: {error_msg}",
